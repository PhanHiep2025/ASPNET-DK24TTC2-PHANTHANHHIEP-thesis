...
namespace ShoesStore.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult AddAddress(int province, int district, string address, string tennguoinhan, string sdtnguoinhan)
        {
            string email = HttpContext.Session.GetString("Email") ?? "phanhiepcc2026@gmail.com";
            Khachhang kh = khRepo.GetCurrentKh(email);
            addressRepo.AddAddressNote(province, district, address, kh.Makh, tennguoinhan, sdtnguoinhan);
